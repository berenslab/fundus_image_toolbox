...
def predict(
    ...
    images = [Img(image).to_tensor(from_cspace='rgb', to_cspace='bgr').to_numpy().img for image in images]
...
if __name__ == "__main__":
    parser = Parser()
    parser.add_argument("--paths", nargs="+", type=str, default=None, help="Paths to images to be segmented.")
    parser.add_argument("--device", type=str, default="cuda:0", help="Device to run inference on.")
    parser.add_argument("--size", type=int, default=512, help="Size of the output masks.")
    parser.add_argument("--save_to", type=str, default=None, help="Path to save the masks, optional.")
    parser.add_argument("--plot", type=bool, default=False, help="Whether to plot the masks.")
    ...
    predict(ensemble_models, args.paths, args.device, args.size, args.save_to, args.plot, args.threshold)
