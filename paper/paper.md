...
- Vessel segmentation. Segmentation of blood vessels in a fundus image using an ensemble of FR-U-Nets trained on the FIVES dataset [@koehler2024]. The ensemble achieved an average Dice score of 0.887 on the test split of the FIVES dataset.
